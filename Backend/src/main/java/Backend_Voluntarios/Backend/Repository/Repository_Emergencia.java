...
public interface Repository_Emergencia extends JpaRepository<Entity_Emergencia, Long> {
    ...
    // save
    @Query("INSERT INTO Entity_Emergencia (tipo_emergencia, zona_emergencia, condicion_fisica, cantidad_voluntarios_minimo, cantidad_voluntarios_maximo) VALUES (:tipo_emergencia, :zona_emergencia, :condicion_fisica, :cantidad_voluntarios_minimo, :cantidad_voluntarios_maximo)")
    void saveEmergencia(@Param("tipo_emergencia") String tipo_emergencia,
